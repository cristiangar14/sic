<section class="nosotros-seccion1">
    ...
    <div class="nosotros-seccion1-banner hseq-seccion1-banner">
        <div class="nosotros-seccion1-banner-color hseq-seccion1-banner-color"></div>
    </div>
