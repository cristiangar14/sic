<section class="home-seccion3">
    <div class="container">
        <div class="row">
            <div class="col-3">
                <div class="home-seccion3-tab nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    <a class="nav-link active" id="home-seccion3-nosotros-tab" data-toggle="pill" href="#home-seccion3-nosotros" role="tab" aria-controls="home-seccion3-nosotros" aria-selected="true">NOSOTROS</a>
                    <a class="nav-link" id="home-seccion3-mision-tab" data-toggle="pill" href="#home-seccion3-mision" role="tab" aria-controls="home-seccion3-mision" aria-selected="false">MISIÓN</a>
                    <a class="nav-link" id="home-seccion3-vision-tab" data-toggle="pill" href="#home-seccion3-vision" role="tab" aria-controls="home-seccion3-vision" aria-selected="false">VISIÓN</a>
                    <a class="nav-link" id="home-seccion3-gcalidad-tab" data-toggle="pill" href="#home-seccion3-gcalidad" role="tab" aria-controls="home-seccion3-gcalidad" aria-selected="false">GESTIÓN DE CALIDAD</a>
                </div>
            </div>
            <div class="col-9">
